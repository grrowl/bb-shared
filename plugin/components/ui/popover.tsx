/* shadcn/ui-derived — vendored from bb's @bb/popover registry entry
 * (`packages/shared-ui/src/components/ui/popover.tsx`). Byte-parity is not
 * required; the only per-plugin difference is the import path for
 * `usePortalScopeProps` which lives at `../../lib/portal-scope`. */
